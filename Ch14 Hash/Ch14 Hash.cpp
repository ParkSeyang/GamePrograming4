...
/* Hash로 만든 자료구조의 장점
* 1. map보다 데이터 접근이 빠르고, 데이터 탐색이 빠르다.
* 
*/
...
void Test1()
{
	...
	// unordered_map : [key - value] :: 9라는 해쉬값에는 252349429라는 숫자가 들어가 있습니다.
	...
	std::cout << "바나나갯수 : " << umap["바나나"] << std::endl;
...
* 왜 유리할까?
* 데이터를 초기화할 때 걸리는 시간
* 순차 컨테이너 > 연관 컨테이너(map) > unordered_map(해시함수가 구현되었고, 해시함수로 저정하는 내부 데이터)
* 
* 해시함수의 단점
